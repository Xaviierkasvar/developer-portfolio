...
const ProjectCard = ({
  ...
  return (
    ...
    >
      ...
      <Box
        sx={{
          // Se removieron los eventos onMouseMove y el efecto hover de transformación
          borderRadius: '6px',
          width: { xs: '94%', md: 'auto' },
          position: "relative",
          transform: isReversed ? 'translateX(-25%)' : 'translateX(25%)',
          maxWidth: '600px',
          padding: '2em 1.5em',
          textAlign: 'left',
      ...
      >
        <Box>
          ...
          <Typography
            color="black"
            variant="h3"
            sx={{ fontSize: { xs: '.83em', sm: '.9em' }, fontWeight: '300' }}
          >
            {description}
          </Typography>
          <Box
